...
public class VerifyCodeUtils{
	...
	public static String generateVerifyCode(int verifySize, String sources){
		...
		StringBuffer verifyCode = new StringBuffer(verifySize);
	 ...
	 * @param width
	 * @param height
	 * @param filePath 存储图片的文件夹
	 * @param verifyCode 图片验证码
	 * @return 图片文件名称
	 * @throws IOException
	 */
	public static String genVerifyImage(int width, int height, String filePath, String verifyCode) throws IOException{
		String fileName = UUID.getUUID()+".jpg";
	 ...
	 * @throws IOException
	 */
	public static void genVerifyImage(int width, int height, OutputStream os,String verifyCode) throws IOException{
